...
public class Graph {
    HashMap<Point, Vertex> mapCoordinateVertex = new HashMap<>(); // map with Point(x,y) and corresponding Vertex
    HashMap<Point, List<Vertex>> mapCoordinateConnectionsFrom = new HashMap<>(); // map with Point(x,y) and Vertexes that reached this point from
    ...
    public void createGraph(Trampoline[][] map) {
        ...
        // list of Vertexes in current row and column, which are not yet connected in graph
        ...
        for (var row = 0; row < rows; ++row) {
            ...
            for (var col = 0; col < columns; ++col) {
                ...
                // at this point mapCoordinateConnectionsFrom are correct and updated, graph connections can be made
